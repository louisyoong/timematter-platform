...
const errorInputCls =
  "w-full px-4 py-3.5 bg-red-50 border border-red-300 rounded-2xl outline-none focus:ring-2 focus:ring-red-400 transition-all text-sm text-gray-700";
...
const AccountSettings: React.FC = () => {
  ...
  const computedAge = useMemo(
    () => calcAge(dobDay, dobMonth, dobYear),
  ...
  const handleProfileSave = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (json.user?.profile_photo_url)
        setCurrentPhotoUrl(json.user.profile_photo_url);
  ...
  const handlePasswordSave = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const token = await getToken();
      if (!token) {
        setPwMsg({ type: "error", text: "Session expired." });
        return;
      }
  ...
  return (
    <div className="min-h-[80vh] bg-[linear-gradient(180deg, #fffdf5 0%, #ffffff 100%)] px-4 py-10 md:py-16">
      <div className="mx-auto w-full max-w-2xl">
        ...
        {/* ══ EDIT PROFILE TAB ════════════════════════════════════════════════ */}
        {activeTab === "profile" && (
          <div className="rounded-[2.5rem] border border-amber-100 bg-white p-6 shadow-xl shadow-amber-50 sm:p-10">
            {!profileLoaded ? (
              ...
              <form onSubmit={handleProfileSave} className="space-y-6">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-emerald-600 py-4 font-bold text-white shadow-xl shadow-amber-100 transition-all hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  <Save size={18} />
              ...
              <div className="space-y-5 py-4 text-center">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500 leading-relaxed max-w-sm mx-auto">
                    Your account was created with Google or Facebook login and
                    does not have a password. Use{" "}
                    <strong>Forgot Password</strong> on the login page to create
                    one.
                  </p>
                </div>
                <a
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`${
                        currentPwError ? errorInputCls : inputCls
                      } pl-11 pr-12`}
                      value={currentPw}
                      onChange={(e) => {
                  ...
                  {currentPwError && (
                    <p className="px-1 text-xs text-red-500 font-medium">
