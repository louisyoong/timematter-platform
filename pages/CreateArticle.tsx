      ...
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            You need an organizer account to submit articles.
          </p>
          <a
            href="#/articles"
            className="mt-6 inline-block text-sm text-emerald-600 font-bold hover:underline"
          >
            ← Back to Articles
          </a>
        </div>
      ...
      <div className="flex min-h-[60vh] items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-gray-500 mb-8">
            Your article has been published to the TimeMatter Journal.
          </p>
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 pb-20">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Share your knowledge with the TimeMatter community.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-7">
        ...
        <div>
          ...
          {bannerPreview ? (
            ...
            <button
              type="button"
              onClick={() => bannerRef.current?.click()}
              className="w-full h-44 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-3 text-gray-400 hover:border-amber-400 hover:text-emerald-500 hover:bg-amber-50 transition-all"
            >
              <ImagePlus size={32} />
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-4 bg-emerald-600 text-white text-sm font-bold rounded-2xl hover:bg-emerald-700 transition-colors disabled:opacity-60 flex items-center justify-center gap-2 shadow-lg shadow-amber-100"
        >
          {submitting ? (
            <>
